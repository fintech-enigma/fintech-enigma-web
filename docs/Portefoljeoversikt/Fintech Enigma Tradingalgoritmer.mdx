...
Våre første trading-algoritmer er nå live og handler basert på EMA-SMA indikatorer og stokastiske trender, de trader nå hhv AAPL og MSFT, følg utviklingen under! Tradingen skjer via <a href="https://alpaca.markets/" style={{color: "#06ADF4"}}>Alpaca Markets</a> sin API, flere algoritmer vil komme!
