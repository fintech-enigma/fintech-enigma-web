...
export const NordnetGraf = () => {
    ...
    const [ fondetsVerdi, setFondetsVerdi ] = useState(1);
    ...
    useEffect( () => {
        ...
        .then(res => {
            if(res.data.status === "OK"){
                ...
                setFondetsVerdi(res.data.FondetsVerdi)
            }
            else{
    ...
    return (
        ...
        <div style={{display: "grid", gridTemplateColumns: "repeat(2, 1fr)"}}>
            ...
            />
            <br/>
            <h1>Porteføljesammensettning</h1>
                ...
                <table className={styles.stock_info_table}>
                    <thead>
                        <tr>
                            ...
                            <td><strong>Antall Aksjer</strong></td>
                        ...
                        return(
                            <tbody>
                                <tr>
                                    <td>{e.aksje}</td>
                                    <td>{e.kostpris}</td>
                                    <td>{((e.andel / fondetsVerdi)*100).toFixed(1)}%</td>
                                    <td>{e.antall_aksjer}</td>
